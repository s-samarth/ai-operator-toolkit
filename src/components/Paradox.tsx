...
const Paradox = () => (
  <SectionWrapper className="bg-surface">
    ...
    <div className="grid md:grid-cols-[1fr_auto_1fr] gap-0 md:gap-0 items-stretch">
      {/* Pro - Winner */}
      <ScrollReveal>
        <div className="border border-google-green/30 rounded-t-lg md:rounded-l-lg md:rounded-tr-none bg-background p-5 sm:p-6 h-full relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-google-green/5 to-transparent pointer-events-none" />
          <div className="relative z-10">
            ...
            <p className="text-body-custom text-xs leading-relaxed mt-4 italic">
      ...
      <div className="flex items-center justify-center py-4 md:py-0 md:px-4">
        <div className="heading-stencil text-4xl sm:text-5xl md:text-6xl text-copper font-extrabold">VS</div>
      </div>
      ...
      <ScrollReveal delay={0.15}>
        <div className="border border-destructive/30 rounded-b-lg md:rounded-r-lg md:rounded-bl-none bg-background p-5 sm:p-6 h-full relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-body-custom text-xs leading-relaxed mt-4 italic">
              27% of capacity wasted on weapons never drawn. Sends correction messages instead of rewinding to checkpoints. Uses Opus to open doors Haiku could handle.
            </p>
          </div>
        </div>
      </ScrollReveal>
