...
const EssentialGear = () => (
  <SectionWrapper>
    ...
    <div className="grid md:grid-cols-2 gap-6">
      <ScrollReveal>
        <div className="border border-google-green/30 rounded-lg p-6 bg-background h-full">
      ...
      <ScrollReveal delay={0.1}>
        <div className="border border-chatgpt-amber/30 rounded-lg p-6 bg-background h-full">
